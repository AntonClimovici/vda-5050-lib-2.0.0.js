...
const vda_5050_validators_1 = require("./vda-5050-validators");
function createUuid() {
    return (0, uuid_1.v4)();
}
...
class Client {
    ...
    validateTopicObject(topic, object) {
        if (!object || typeof object !== "object") {
            throw new TypeError(`Invalid VDA 5050 object ${object}`);
        }
        switch (topic) {
            case __1.Topic.Connection:
                if (!(0, vda_5050_validators_1.validateConnection)(object)) {
                    throw new TypeError(`Invalid VDA 5050 Connection at ${vda_5050_validators_1.validateConnection.errors[0].keywordLocation}, ${vda_5050_validators_1.validateConnection.errors[0].instanceLocation}`);
                }
                break;
            case __1.Topic.InstantActions:
                if (!(0, vda_5050_validators_1.validateInstantActions)(object)) {
                    throw new TypeError(`Invalid VDA 5050 InstantActions at ${vda_5050_validators_1.validateInstantActions.errors[0].keywordLocation}, ${vda_5050_validators_1.validateInstantActions.errors[0].instanceLocation}`);
                }
                break;
            case __1.Topic.Order:
                if (!(0, vda_5050_validators_1.validateOrder)(object)) {
                    throw new TypeError(`Invalid VDA 5050 Order at ${vda_5050_validators_1.validateOrder.errors[0].keywordLocation}, ${vda_5050_validators_1.validateOrder.errors[0].instanceLocation}`);
                }
                break;
            case __1.Topic.State:
                if (!(0, vda_5050_validators_1.validateState)(object)) {
                    throw new TypeError(`Invalid VDA 5050 State at ${vda_5050_validators_1.validateState.errors[0].keywordLocation}, ${vda_5050_validators_1.validateState.errors[0].instanceLocation}`);
                }
                break;
            case __1.Topic.Visualization:
                if (!(0, vda_5050_validators_1.validateVisualization)(object)) {
                    throw new TypeError(`Invalid VDA 5050 Visualization at ${vda_5050_validators_1.validateVisualization.errors[0].keywordLocation}, ${vda_5050_validators_1.validateVisualization.errors[0].instanceLocation}`);
                }
                break;
            default:
...
Client.VDA_5050_PROTOCOL_VERSION = "1.1.0";
