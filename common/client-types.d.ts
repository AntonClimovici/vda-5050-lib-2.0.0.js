 ...
 * @category Common
 */
export type ExtensionObject = Header & {
    [key: string]: any;
};
/**
 ...
 * @category Common
 */
export type Headerless<T extends Vda5050Object> = {
    [H in keyof Pick<T, "timestamp">]?: T[H];
} & Omit<T, keyof Header>;
/**
 ...
 * @category Common
 */
export declare function isExtensionTopic(topic: string): boolean;
/**
 ...
 * @category Client
 */
export type SubscriptionHandler<T extends string> = (object: TopicObject<T>, subject: AgvId, topic: T, subscriptionId: SubscriptionId) => void;
/**
 * Function type of callback invoked on connection state changes.
 *
 * @category Client
 */
export type ConnectionStateChangeCallback = (connectionState: "online" | "offline" | "broken", previousConnectionState: "online" | "offline" | "broken") => void;
/**
